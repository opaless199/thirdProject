...
<li class="insta">
<a href="https://instagram.com/pascucci_kr">Instagram</a>
</li>
<li class="youtube">
<a href="https://www.youtube.com/channel/UCHKRIWTWjq0uzJOAm6KFHOg">Youtube</a>
</li>
</ul>
</div>
</header>
	...
	<nav class="navbar navbar-default">
		...
		<!-- <div class="navbar-header" id="company"> -->
		<div>
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<!-- <ul class="nav navbar-nav"> -->
							...
							<li><a href="productListForm.jsp">상품</a>
							<ul class="dept02">
							<li><a href="#">모니터</a></li>
							<li><a href="#">키보드</a></li>
							<li><a href="#">마우스</a></li>
							...
							<li><a href="/WJElectronics/client/cliNotice.do">공지사항</a>
							<ul class="dept02">
